!function(t) {
    ...
    var s = function(t) {
        ...
        this.isRandomColor = t.options.isRandomColor, this.isRandomColor && (this.particleColor = function() {
            var t, i = "#";
            do {
                for (i = "#", t = 0; t < 6; t++) {
                    var s = "0123456789ABCDEF";
                    0 == t ? s = s.replace("CDEF", "") : t % 2 == 1 && (s = s.replace("012345", ""));
                    var a = s.charAt(Math.floor(Math.random() * s.length));
                    i += a;
                }
            } while (e(i));
            return i;
    ...
    function e(t) {
        var i = .2126 * (parseInt(t.substr(1, 2), 16) / 255) + .7152 * (parseInt(t.substr(3, 2), 16) / 255) + .0722 * (parseInt(t.substr(5, 2), 16) / 255);
        return i > .7 || i < .3;
    }
    return s.prototype.update = function() {
        ...
        this.canvasDiv = t, this.canvasDiv.size = {
            ...
            opacityMin: void 0 !== i.opacityValue ? i.opacityValue : .5,
            ...
            sizeMin: void 0 !== i.sizeMin ? i.sizeMin : .8,
            isRandomColor: void 0 !== i.interactive && i.isRandomColor
        }, this.init();
