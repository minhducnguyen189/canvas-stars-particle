!function(t) {
    ...
    var s = function(t) {
        ...
        this.opacity = .9992715378120091, this.opacity_min = t.options.opacityMin, this.change_size = t.options.changeSize, 
        this.size_status, this.radius = 1, this.size_min = t.options.sizeMin, this.size = t.options.size * Math.random(), 
    ...
    return s.prototype.update = function() {
        ...
        return "high" === t ? 1e3 : "low" === t ? 2e4 : isNaN(parseInt(t, 10)) ? 1e4 : t;
